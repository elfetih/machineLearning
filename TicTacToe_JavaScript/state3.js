function MenuState(name) {
	...
	btns.push(new MenuButton("About Game", 20, _yPos+140, function() {
...
function AboutState(name) {
	...
	var text = "Tic-tac-toe est un jeu pour deux joueurs, X et O, qui marquent à tour de rôle les espaces dans une grille de 3 × 3. Le joueur qui réussit à placer trois marques respectives dans une rangée horizontale, verticale ou diagonale gagne la partie.";
	var hastick = false;
