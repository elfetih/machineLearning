...
function AboutState(name) {
	...
	var text = "Tic-tac-toe est un jeu pour deux joueurs, X et O, qui marquent à tour de rôle les espaces dans une grille de 4 × 4. Le joueur qui réussit à placer trois marques respectives dans une rangée horizontale, verticale ou diagonale gagne la partie.";
	var hastick = false;
